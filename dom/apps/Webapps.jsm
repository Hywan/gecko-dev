...
this.DOMApplicationRegistry = {
  ...
  installHTMLRunnerRootApp: Task.async(function*() {
    ...
    let sourceDirPath = Services.prefs.getCharPref("htmlrunner.rootAppSource");
    ...
    Services.obs.notifyObservers(null, "htmlrunner-rootapp-installed", null);
  ...
  loadAndUpdateApps: function() {
    return Task.spawn(function() {
      ...
      if (runUpdate) {
        ...
        yield this.installHTMLRunnerRootApp();
#endif
